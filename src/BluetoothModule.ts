...
export default class BluetoothModule {
  ...
  async getBondedDevices(): Promise<BluetoothDevice[]> {
    let bonded: BluetoothNativeDevice[] =
      await this._nativeModule.getBondedDevices();
  ...
  async getConnectedDevices(): Promise<BluetoothDevice[]> {
    let connected: BluetoothNativeDevice[] =
      await this._nativeModule.getConnectedDevices();
    let devices: BluetoothDevice[] = [];
  ...
  async startDiscovery(): Promise<BluetoothDevice[]> {
    ...
    let discoveredDevices: BluetoothNativeDevice[] =
      await this._nativeModule.startDiscovery();
